<div class="topbar">
  <div class="topbar-left">
    ...
    <div class="topbar-search d-none d-md-block">
      ...
      <input type="text" placeholder="Cari data anak, pemeriksaan...">
    </div>
  </div>
    ...
    <div class="d-flex align-items-center gap-2">
      ...
      <div class="dropdown">
        <div class="user-dropdown-premium" data-bs-toggle="dropdown" aria-expanded="false">
          <img src="{{ auth()->user()->avatar ? asset('storage/'.auth()->user()->avatar) : 'https://ui-avatars.com/api/?name='.urlencode(auth()->user()->name).'&background=2E86AB&color=fff&bold=true' }}" 
        ...
        <ul class="dropdown-menu dropdown-menu-end dropdown-menu-premium shadow-lg animate slideIn">
          <li class="px-3 py-2 border-bottom mb-2 d-lg-none text-center">
          ...
          <li>
            <a class="dropdown-item dropdown-item-premium" href="#">
              <i class="fas fa-gear text-primary"></i> Pengaturan Akun
            </a>
          </li>
